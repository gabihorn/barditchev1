...
<head>
    ...
    <title>קהילת ברדיטשוב - קמפיין חברי בית הכנסת</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1 class="animate-on-scroll glow-text">🕍 קהילת ברדיטשוב - בית שמש</h1>
            <h2 class="animate-on-scroll highlight-text" style="animation-delay: 0.2s;">קמפיין חברי בית הכנסת</h2>
            <p class="animate-on-scroll" style="animation-delay: 0.4s;">מהחצר של שלמה ועד לבית כנסת שלנו</p>
        </div>
